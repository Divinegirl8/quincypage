...
const books = [
  {
    ...
    descriptionH: descriptionTxt2,
    linkE: "https://selar.com/w96nx9",
    linkH:
      "https://www.amazon.com/OMEIHEUKWU-One-Does-Extraordinary-Things/dp/B0CLLHKBRH?ref_=ast_author_dp&dib=eyJ2IjoiMSJ9.3ysb2vwMitpM1d-3XvjIewAewSbwW8GBhAU1XC4wDoU.ZcU0EZsrtUu6Yyu9i4fMUiM3dOtrPgrj6W3MLCSw3zw&dib_tag=AUTHOR",
  },
  {
    title: "THE LITERARY SEDUCER",
    img: literary,
    descriptionE: descriptionTxt1,
    descriptionH: descriptionTxt2,
    linkE: "https://selar.com/eth2",
    linkH: "https://www.amazon.com/gp/aw/d/B09SNMYHQ6/ref=tmm_pap_swatch_0",
  },
  {
    title: "TAKE CHARGE RIGHT NOW!",
    img: charge,
    descriptionH: descriptionTxt2,
    linkH:
      "https://www.amazon.com/TAKE-CHARGE-RIGHT-NOW-self-confidence/dp/B0B5KQVJ5Y/",
  },
  {
    title: "HOW TO CRAFT KILLER OFFERS THAT CONVERT",
    img: craft,
    descriptionE: descriptionTxt1,
    linkE: "https://selar.com/016050",
  },
  {
    title: "THE ART OF CHARGING MORE",
    img: charging,
    descriptionE: descriptionTxt1,
  ...
  {
    title: "HOW TO PACE YOUR STORIES LIKE A PRO",
    img: pace,
    descriptionE: descriptionTxt1,
...
const Book: React.FC = () => {
  return (
    <div className="relative w-full px-4 py-6 max-h-screen  bg-white">
    
    <p className="text-sm text-gray-500 text-center mb-4 animate-bounce">
      Scroll up to explore more books
    </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 justify-items-center">
        {books.map((book, index) => (
          ...
          >
            ...
            {book.descriptionE && (
              <button
                className="mt-1 px-3 py-1 bg-black text-white text-sm font-medium rounded shadow-sm transition cursor-pointer"
                onClick={() => {
            ...
            {book.descriptionH && (
              <button
                className="mt-2 px-3 py-1 bg-black text-white text-sm font-medium rounded shadow-sm transition cursor-pointer"
                onClick={() => {
